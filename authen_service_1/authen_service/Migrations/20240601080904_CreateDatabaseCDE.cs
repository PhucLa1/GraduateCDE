...
{
    /// <inheritdoc />
    public partial class CreateDatabaseCDE : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    server_location = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    start_date = table.Column<DateTime>(type: "datetime2", nullable: false),
                    end_date = table.Column<DateTime>(type: "datetime2", nullable: false),
                    description = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    todo_permission = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    work_phone_number = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    mobile_phone_number = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    language_preference = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ...
                    link_account = table.Column<int>(type: "int", nullable: true),
